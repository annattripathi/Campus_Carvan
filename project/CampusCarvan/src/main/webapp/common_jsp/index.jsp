...
<body style="overflow-x: hidden">
	...
	<div class="row container">
		<div class="col-11" style="margin-top: 1%">

			<h3 style="margin-left: 5%">MAKE A DIFFERENCE IN YOUR COMMUNITY
				. BECOME A COMPUS CARVAN DRIVER.</h3>
		</div>

		<div class="col-1" style="margin-top: 1%">

			<button type="button" class="btn btn-primary"
				style="width: 180%; height: 85%; margin-bottom:">APPLY HERE</button>
